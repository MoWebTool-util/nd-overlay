...
describe('overlay', function () {
  ...
  it('基本属性', function () {
    ...
    expect(parseInt(overlay.element[0].style.zIndex, 10)).to.equal(90);
  ...
  it('默认属性', function () {
    ...
    expect(parseInt(overlay.element[0].style.zIndex, 10)).to.equal(99);
    expect(overlay.get('visible')).to.equal(false);
  ...
  it('设置属性', function () {
    ...
    expect(parseInt(overlay.element[0].style.zIndex, 10)).to.equal(101);
